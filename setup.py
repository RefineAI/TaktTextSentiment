...
setup(
  name = 'TaktSentiment',
  #packages = ['TaktSentiment'], # this must be the same as the name above
  ...
  url = 'https://github.com/cjhutto/TaktSentiment', # use the URL to the github repo
  download_url = 'https://github.com/cjhutto/TaktSentiment/archive/master.zip',
